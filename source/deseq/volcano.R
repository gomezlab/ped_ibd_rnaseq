...
EnhancedVolcano(res,
    ...
    lab = res$gene,
    selectLab = c('HCAR3', 'CXCL8', 'AQP9', 'CXCL5', 'DUOX2', 'CHI3L1', 'MUC6', 'IL1B', 'IL1A', 'REG1B', 'GSTA1', 'MTCO1P2'),
    x = 'log2FoldChange',
    y = 'padj',
    legendLabels = c("NS", "p-adj", "L2FC", "p < 0.05 and L2FC > 1.5"),
    pCutoff = 0.05,
...
EnhancedVolcano(res,
    lab = res$X,
    selectLab = c('MMP1', 'CXCL5', 'CXCL8', 'FOXP3', 'INHBA', 'IL1B', 'TIMP1', 'DUOXA2', 'CXCL1', 'MTCO1P12', 'CLDN8'),
